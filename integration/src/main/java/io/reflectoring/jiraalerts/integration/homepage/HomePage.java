...
public class HomePage extends BasePage {
	...
	public HomePage() {
		...
		MultiLineLabel applicationDeactivatedLabel = new MultiLineLabel("applicationDeactivatedLabel",
		        new StringResourceModel("application.deactivated", HomePage.this));
