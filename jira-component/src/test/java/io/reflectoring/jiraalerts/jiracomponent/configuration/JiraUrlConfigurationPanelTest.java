...
public class JiraUrlConfigurationPanelTest {
  ...
  @Autowired private JiraConnectionConfigurationService jiraConnectionConfigurationServiceMock;
  ...
  public void homepageRendersSuccessfully() {
    ...
    wicketTester.assertComponent(
        "connectionUrlForm:submitNewConnectionUrlLink", AjaxSubmitLink.class);
  }
  ...
  public void formSubmitCallsServicesForSavingNewData() throws Exception {
    ...
    verify(jiraConnectionConfigurationServiceMock, times(3))
        .loadConnectionUrl(JIRA_CONNECTION_DATA_ID);
    verify(jiraConnectionConfigurationServiceMock)
        .saveConnectionUrl(JIRA_CONNECTION_DATA_ID, NEW_VALUE_TO_SAVE);
  }
}
