...
public class EditRoutineQueryPageTest {
	...
	private static final long TEST_QUERY_ID = 11833;
	...
	public void setUp() throws Exception {
		...
		wicketTester.startPage(new EditRoutineQueryPage(createPageParameters(TEST_QUERY_ID)));
		when(routineQueryServiceMock.loadRoutineQueryDTOById(TEST_QUERY_ID)).thenReturn(new RoutineQueryDTO());
	}
	...
	public void redirectsToLoginPageWhenRoleIsNotCorrectRole() throws Exception {
	...
	public void validFormDataCallsServiceToPersistRoutineQuery() throws Exception {
		...
		verify(routineQueryServiceMock).updateRoutineQuery(routineQueryDTOArgumentCaptor.capture());
