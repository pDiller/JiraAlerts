...
public class StepperMotor {
    ...
    /**
     * Rotates the motor for the given number of revolutions. You can use the value 2 to rotate the motor twice, 0.5 to rotate only half way or negative numbers
     * like -1 to rotate once in reverse.
     * 
     * @param revolutions
